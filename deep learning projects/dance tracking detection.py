...
# Load video
video_path = r"D:\NIT drive notes prakash senapati\DEEP LEARNING\Dance Tracking Detection\dance tracking input video.mp4"
cap = cv2.VideoCapture(video_path)

# Create VideoWriter object to save output video
output_path = r"D:\NIT drive notes prakash senapati\DEEP LEARNING\output_video.mp4"
